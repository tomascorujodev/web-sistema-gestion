            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        <div className={`flex items-center gap-2 ${step >= 1 ? 'text-brand' : 'text-gray-500'}`}>
                        ...
                        <div className={`flex items-center gap-2 ${step >= 2 ? 'text-brand' : 'text-gray-500'}`}>
                        ...
                        <div className="animate-in fade-in slide-in-from-left-4 duration-300">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <div className="space-y-1">
                                    ...
                                    <input
                                        className={`w-full bg-white/5 border ${errors.name ? 'border-red-500' : 'border-white/10'} p-3 rounded text-white focus:outline-none focus:border-brand`}
                                        value={formData.name}
                                ...
                                <div className="space-y-1">
                                    ...
                                    <input
                                        className={`w-full bg-white/5 border ${errors.surname ? 'border-red-500' : 'border-white/10'} p-3 rounded text-white focus:outline-none focus:border-brand`}
                                ...
                                <div className="space-y-1">
                                    <label className="text-xs font-bold uppercase text-gray-500">DNI o CUIT *</label>
                                    <input
                                        className={`w-full bg-white/5 border ${errors.dniOrCuit ? 'border-red-500' : 'border-white/10'} p-3 rounded text-white focus:outline-none focus:border-brand`}
                                ...
                                <div className="space-y-1">
                                    <label className="text-xs font-bold uppercase text-gray-500">Teléfono (WhatsApp) *</label>
                                    <input
                                        className={`w-full bg-white/5 border ${errors.phone ? 'border-red-500' : 'border-white/10'} p-3 rounded text-white focus:outline-none focus:border-brand`}
                            ...
                            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-2 pt-4 border-t border-white/10">
                            ...
                            <div className="flex gap-4 mb-6">
                                <button
                                    ...
                                    className={`flex-1 p-4 border-2 rounded-xl flex flex-col items-center gap-2 transition-all ${formData.deliveryMethod === 'envio' ? 'border-brand bg-brand/5 text-brand' : 'border-white/10 text-gray-500 hover:bg-white/5'}`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex-1 p-4 border-2 rounded-xl flex flex-col items-center gap-2 transition-all ${formData.deliveryMethod === 'retiro' ? 'border-brand bg-brand/5 text-brand' : 'border-white/10 text-gray-500 hover:bg-white/5'}`}
                                >
                            ...
                            {formData.deliveryMethod === 'retiro' ? (
                                <div className="mb-6 animate-in fade-in">
                                    <label className="text-xs font-bold uppercase text-gray-500 block mb-1">Sucursal de Retiro</label>
                                    <select
                                        className="w-full bg-white/5 border border-white/10 p-3 rounded text-white focus:outline-none focus:border-brand [&>option]:bg-black [&>option]:text-white"
                                ...
                                <div className="space-y-4 mb-6 animate-in fade-in">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="md:col-span-2 space-y-1">
                                            <label className="text-xs font-bold uppercase text-gray-500">Calle *</label>
                                            <input
                                                className={`w-full bg-white/5 border ${errors.addressStreet ? 'border-red-500' : 'border-white/10'} p-3 rounded text-white focus:outline-none focus:border-brand`}
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <input
                                                className={`w-full bg-white/5 border ${errors.addressNumber ? 'border-red-500' : 'border-white/10'} p-3 rounded text-white focus:outline-none focus:border-brand`}
                    ...
                    {step === 2 && (
                        <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                            ...
                            <div className="space-y-4 mb-8">
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <span className="font-bold text-lg text-white block">Coordinar con el Vendedor</span>
                                        <span className="text-sm text-gray-500">Efectivo, Transferencia o Tarjeta en el local.</span>
                                    </div>
                            ...
                            <div className="flex justify-between items-center">
                                <button
                                    onClick={() => setStep(1)}
                                    className="text-gray-500 hover:text-white font-medium flex items-center gap-2"
                                >
                ...
                <div className="lg:col-span-1">
                    <div className="bg-neutral-900 border border-white/10 rounded-xl p-6 sticky top-28">
                        <h3 className="text-lg font-bold text-white mb-4 uppercase tracking-wider">Tu Pedido</h3>
